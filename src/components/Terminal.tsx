...
`;
    ...
    exit: () => {
      ...
      setTimeout(() => {
        setIsExiting(false);
        setHistory(prev => [...prev, 'Goodbye...', '', 'Terminal restarted. Type "help" for available commands.']);
      }, 2000);
      return 'Exiting...';
    }
  };
  ...
  const handleCommand = () => {
    ...
    if (commands[commandName]) {
      ...
      newHistory.push(`Command not found: ${commandName}. Type 'help' for available commands.`);
    }
  ...
  return (
    ...
    >
      <div className="flex items-center bg-gray-800 px-4 py-2">
        ...
        <div className="ml-4 text-gray-400 text-sm font-mono">terminal@taisei.dev</div>
      </div>
      ...
      >
        ...
        {history.map((line, index) => (
          <div key={index} className={`whitespace-pre-wrap ${line.startsWith('>') ? 'text-blue-400' : 'text-gray-300'}`}>
            {line}
          </div>
        ))}
          ...
          <span className="relative flex items-center">
            ...
            <span 
              ...
              style={{ 
                ...
                transform: cursorPosition > 0 ? 'translateX(8px)' : 'translateX(0)'
              }}
            ></span>
          </span>
          <input
